...
export default function AuthModal({ isOpen, onClose, setIsLoggedIn }) {
  ...
  const res = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/users/loginOrRegister`, {
    method: "POST",
...
const handleCompleteProfile = async () => {
  ...
  const res = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/users/completeProfile`, {
    method: "POST",
    headers: {
